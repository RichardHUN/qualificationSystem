...
public interface TrackTimeController {
    ...
    @PostMapping("/dto")
    ResponseEntity<TrackTime> create(@RequestBody TrackTimeDTO trackTime);
    ...
    @PutMapping("/dto/{id}")
    ResponseEntity<TrackTime> updateWithDTO(@PathVariable UUID id, @RequestBody TrackTimeDTO trackTime);
